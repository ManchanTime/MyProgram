...
public class HotAdapter extends RecyclerView.Adapter<HotAdapter.HotViewHolder> {
    ...
    public static class HotViewHolder extends RecyclerView.ViewHolder{
        ...
        public HotViewHolder(CardView v){
            super(v);
            cardView = v;
        }
    }

    public HotAdapter(Activity activity, ArrayList<PostInfo> myDataset){
        mDataset = myDataset;
    ...
    public HotAdapter.HotViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        final HotViewHolder userPostViewHolder = new HotViewHolder(cardView);
    ...
    @Override
    public void onBindViewHolder(@NonNull final HotViewHolder holder, @SuppressLint("RecyclerView") int position){
