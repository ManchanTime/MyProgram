...
public class UserPostAdapter extends RecyclerView.Adapter<UserPostAdapter.UserPostViewHolder> {
    ...
    public static class UserPostViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserPostViewHolder(CardView v){
            super(v);
            cardView = v;
        }
    }

    public UserPostAdapter(Activity activity, ArrayList<PostInfo> myDataset){
        mDataset = myDataset;
    ...
    @NonNull
    @Override
    public UserPostAdapter.UserPostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        CardView cardView = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.item_post, parent, false);
        final UserPostViewHolder userPostViewHolder = new UserPostViewHolder(cardView);
        cardView.setOnClickListener((v) -> {
            Intent intent = new Intent(activity, PostViewActivity.class);
            intent.putExtra("like_list",likeList);
            intent.putExtra("object",mDataset.get(userPostViewHolder.getAdapterPosition()));
            if(mDataset.get(userPostViewHolder.getAdapterPosition()) == null){
